...
if ( ! function_exists( 'storefront_credit' ) ) {
	...
	function storefront_credit() {
		...
		<div class="site-info">
			...
			<br /> <?php printf( __( '%1$s designed by %2$s.', 'storefront' ), 'Las Lechuzas', '<a href="http://www.4ws.com.ar" alt="Tema desarrollado por 4ws" title="Tema desarrollado por 4ws" rel="designer">4ws</a>' ); ?>
			<?php } ?>
		</div><!-- .site-info -->
		<?php
	}
